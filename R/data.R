...
#'
#' @format ## `example_data`
#' A tsibble with 14,141 rows and 8 columns:
#' \describe{
...
#'   \item{v2x_polyarchy}{Electoral democracy score from V-Dem}
#' }
#' @source [PRIO Battle-deaths 3.1](https://www.prio.org/data/1)
#' @source [UCDP GED 25.1](https://ucdp.uu.se)
#' @source [cShapes 2.0](https://icr.ethz.ch/data/cshapes/)
#' @source [Varieties of Democracy 16](https://v-dem.net/)
#' @source [Penn World Tables 11.0](https://www.rug.nl/ggdc/productivity/pwt)
